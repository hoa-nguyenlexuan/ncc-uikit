                ...
                items.map(function (item) {
                    ...
                    return (React__default['default'].createElement(StyledList, { key: item.label },
                        ...
                        _a.map(function (_a) {
                            ...
                            return (React__default['default'].createElement(StyledListItem, { key: label }, href ? (React__default['default'].createElement(Link, { href: href, color: isHighlighted ? baseColors.warning : darkColors.text, bold: false }, label)) : (React__default['default'].createElement(StyledText, null, label))));
                        })));
                }),
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, { mt: !subLinks ? totalTopMenuHeight + 1 + "px" : "0" },
            React__default['default'].createElement(Inner, { isPushed: false, showMenu: showMenu },
                children,
                React__default['default'].createElement(MenuItem, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, buyCakeLabel: buyCakeLabel, onClickBuyCake: onClickBuyCake, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
